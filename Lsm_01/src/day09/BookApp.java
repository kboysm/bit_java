...
public class BookApp {
	...
	public static void main(String[] args) {
	 ...
	 for (;;) {
			...
			System.out.println("1. 판매할 책 등록");
			System.out.println("2. 등록 상품 삭제");
			System.out.println("3. 등록 상품 보기");
			System.out.println("4. 검색");
			System.out.println("5. App종료");
			System.out.println("******************************");
			System.out.println(" ");
			System.out.println(" ");
			...
			case 1:
				...
				String title=lsm.nextLine();
				System.out.println("책 가격 입력");
				int price=lsm.nextInt();
				lsm.nextLine();
			...
			case 2:
				...
				mgr.bookListPrint();
				System.out.println("삭제할 책 넘버를 입력");
				int num = lsm.nextInt();
				mgr.delBook(num);
				lsm.nextLine();
				break;
